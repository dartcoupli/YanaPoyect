...
public class ActivityCopiadeseguridad implements Serializable
{
	...
	public ActivityCopiadeseguridad() {
		super();
	}
	public ActivityCopiadeseguridad(int acid, int acusid, Date accrdt, Date acdate, int accate, String actitle, String acdesc,
			int acpmin, int acpmax, float acprecio, City accity) {
		super();
		this.acid = acid;
		this.acusid = acusid;
		this.accrdt = accrdt;
	...
	public City getAccity() {
		return accity;
	}
	public void setAccity(City accity) {
		this.accity = accity;
	}
	...
	public String toString() {
		return "Activity [acid=" + acid + ", acusid=" + acusid + ", accrdt=" + accrdt + ", acdate=" + acdate
				...
				+ ", acpmax=" + acpmax + ", acprecio=" + acprecio + ", accity=" + accity + "]";
	}
