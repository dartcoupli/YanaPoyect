    ...
    <section class="page-section" id="register">
        <div class="container">
            ...
            <form name="sentRegister" accept-charset="utf-8" id="registerForm" novalidate="novalidate" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <div class="row">
                    <div class="col-lg-6">
